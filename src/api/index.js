...
const DUMMY_JSON_API = "http://localhost:3001/api/v1/ecomproducts";
//const DUMMY_JSON_API = "http://localhost:3001/api/v1/products";
...
export const fetchProductsByIdApi = (setLoading, id) => async (dispatch) => {
  const URL = `${DUMMY_JSON_API}/${id}`
